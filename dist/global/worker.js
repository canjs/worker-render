...
define('worker-render@1.1.5#worker/handlers/initial', function (require, exports, module) {
...
/*worker-render@1.1.5#worker/handlers/event*/
define('worker-render@1.1.5#worker/handlers/event', function (require, exports, module) {
...
define('worker-render@1.1.5#worker/handlers/globals/special', function (require, exports, module) {
    var Location = require('micro-location@0.1.4#lib/micro-location');
    var extend = require('worker-render@1.1.5#simple_extend');
...
/*worker-render@1.1.5#worker/handlers/global-event*/
define('worker-render@1.1.5#worker/handlers/global-event', function (require, exports, module) {
    var can = require('can@2.3.0-pre.2#util/util');
    var special = require('worker-render@1.1.5#worker/handlers/globals/special');
    module.exports = function (data) {
        var event = data.event;
...
/*worker-render@1.1.5#worker/handlers/handlers*/
define('worker-render@1.1.5#worker/handlers/handlers', function (require, exports, module) {
    exports.initial = require('worker-render@1.1.5#worker/handlers/initial');
    exports.event = require('worker-render@1.1.5#worker/handlers/event');
    exports.globalEvent = require('worker-render@1.1.5#worker/handlers/global-event');
});
/*dom-patch@1.0.0#scheduler*/
define('dom-patch@1.0.0#scheduler', function (require, exports, module) {
    var nodeRoute = require('node-route@1.0.1#dom-id');
...
/*dom-patch@1.0.0#overrides/util/mark_in_document*/
define('dom-patch@1.0.0#overrides/util/mark_in_document', function (require, exports, module) {
...
/*dom-patch@1.0.0#overrides/util/in_document*/
define('dom-patch@1.0.0#overrides/util/in_document', function (require, exports, module) {
...
/*dom-patch@1.0.0#overrides/insert*/
define('dom-patch@1.0.0#overrides/insert', function (require, exports, module) {
    var schedule = require('dom-patch@1.0.0#scheduler').schedule;
    var nodeRoute = require('node-route@1.0.1#dom-id');
    var markAsInDocument = require('dom-patch@1.0.0#overrides/util/mark_in_document');
    var inDocument = require('dom-patch@1.0.0#overrides/util/in_document');
    var serialize = require('dom-patch@1.0.0#node_serialization').serialize;
...
/*dom-patch@1.0.0#overrides/remove*/
define('dom-patch@1.0.0#overrides/remove', function (require, exports, module) {
    var schedule = require('dom-patch@1.0.0#scheduler').schedule;
    var nodeRoute = require('node-route@1.0.1#dom-id');
    var markAsInDocument = require('dom-patch@1.0.0#overrides/util/mark_in_document');
    var inDocument = require('dom-patch@1.0.0#overrides/util/in_document');
...
/*dom-patch@1.0.0#overrides/attributes*/
define('dom-patch@1.0.0#overrides/attributes', function (require, exports, module) {
    var schedule = require('dom-patch@1.0.0#scheduler').schedule;
    var inDocument = require('dom-patch@1.0.0#overrides/util/in_document');
...
/*dom-patch@1.0.0#overrides/prop*/
define('dom-patch@1.0.0#overrides/prop', function (require, exports, module) {
    var schedule = require('dom-patch@1.0.0#scheduler').schedule;
    var inDocument = require('dom-patch@1.0.0#overrides/util/in_document');
...
/*dom-patch@1.0.0#overrides/events*/
define('dom-patch@1.0.0#overrides/events', function (require, exports, module) {
    var schedule = require('dom-patch@1.0.0#scheduler').schedule;
    var scheduleGlobal = require('dom-patch@1.0.0#scheduler').scheduleGlobal;
    var inDocument = require('dom-patch@1.0.0#overrides/util/in_document');
    module.exports = function (Node) {
        var window = this;
        var proto = Node.prototype;
...
/*dom-patch@1.0.0#overrides/history*/
define('dom-patch@1.0.0#overrides/history', function (require, exports, module) {
    var scheduleGlobal = require('dom-patch@1.0.0#scheduler').scheduleGlobal;
...
/*dom-patch@1.0.0#patch/patch*/
define('dom-patch@1.0.0#patch/patch', function (require, exports, module) {
    var scheduler = require('dom-patch@1.0.0#scheduler');
    var markAsInDocument = require('dom-patch@1.0.0#overrides/util/mark_in_document');
    var overrides = [
            require('dom-patch@1.0.0#overrides/insert'),
            require('dom-patch@1.0.0#overrides/remove'),
            require('dom-patch@1.0.0#overrides/attributes'),
            require('dom-patch@1.0.0#overrides/prop'),
            require('dom-patch@1.0.0#overrides/events'),
            require('dom-patch@1.0.0#overrides/history')
        ];
...
/*dom-patch@1.0.0#patch*/
define('dom-patch@1.0.0#patch', function (require, exports, module) {
    module.exports = require('dom-patch@1.0.0#patch/patch');
});
/*worker-render@1.1.5#worker/overrides/history*/
define('worker-render@1.1.5#worker/overrides/history', function (require, exports, module) {
    var Location = require('micro-location@0.1.4#lib/micro-location');
    var extend = require('worker-render@1.1.5#simple_extend');
    module.exports = function () {
        var history = window.history;
...
define('worker-render@1.1.5#worker/worker', function (require, exports, module) {
    var handlers = require('worker-render@1.1.5#worker/handlers/handlers');
    var patch = require('dom-patch@1.0.0#patch');
    var overrides = [require('worker-render@1.1.5#worker/overrides/history')];
...
define('worker-render@1.1.5#worker', function (require, exports, module) {
    module.exports = require('worker-render@1.1.5#worker/worker');
});
/*worker-render@1.1.5#worker/global*/
define('worker-render@1.1.5#worker/global', function (require, exports, module) {
    self.workerRender = require('worker-render@1.1.5#worker');
});
/*[global-shim-end]*/
(function (){
