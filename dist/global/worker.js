...
define('worker-render@1.2.0#simple_extend', function (require, exports, module) {
...
/*worker-render@1.2.0#worker/handlers/initial*/
define('worker-render@1.2.0#worker/handlers/initial', function (require, exports, module) {
    var Location = require('micro-location@0.1.4#lib/micro-location');
    var extend = require('worker-render@1.2.0#simple_extend');
...
define('worker-render@1.2.0#worker/handlers/event', function (require, exports, module) {
...
define('worker-render@1.2.0#worker/handlers/globals/special', function (require, exports, module) {
    var Location = require('micro-location@0.1.4#lib/micro-location');
    var extend = require('worker-render@1.2.0#simple_extend');
...
/*worker-render@1.2.0#worker/handlers/global-event*/
define('worker-render@1.2.0#worker/handlers/global-event', function (require, exports, module) {
    var can = require('can@2.3.0-pre.2#util/util');
    var special = require('worker-render@1.2.0#worker/handlers/globals/special');
    module.exports = function (data) {
        var event = data.event;
...
/*worker-render@1.2.0#worker/handlers/handlers*/
define('worker-render@1.2.0#worker/handlers/handlers', function (require, exports, module) {
    exports.initial = require('worker-render@1.2.0#worker/handlers/initial');
    exports.event = require('worker-render@1.2.0#worker/handlers/event');
    exports.globalEvent = require('worker-render@1.2.0#worker/handlers/global-event');
});
...
define('worker-render@1.2.0#worker/overrides/history', function (require, exports, module) {
    var Location = require('micro-location@0.1.4#lib/micro-location');
    var extend = require('worker-render@1.2.0#simple_extend');
    module.exports = function () {
        var history = window.history;
...
define('worker-render@1.2.0#worker/worker', function (require, exports, module) {
    var handlers = require('worker-render@1.2.0#worker/handlers/handlers');
    var patch = require('dom-patch@1.0.4#patch');
    var overrides = [require('worker-render@1.2.0#worker/overrides/history')];
...
/*worker-render@1.2.0#worker*/
define('worker-render@1.2.0#worker', function (require, exports, module) {
    module.exports = require('worker-render@1.2.0#worker/worker');
});
/*worker-render@1.2.0#worker/global*/
define('worker-render@1.2.0#worker/global', function (require, exports, module) {
    self.workerRender = require('worker-render@1.2.0#worker');
});
/*[global-shim-end]*/
(function (){
