...
/*dom-patch@1.0.4#apply/apply*/
define('dom-patch@1.0.4#apply/apply', function (require, exports, module) {
    var deserialize = require('dom-patch@1.0.4#node_serialization').deserialize;
...
/*dom-patch@1.0.4#apply*/
define('dom-patch@1.0.4#apply', function (require, exports, module) {
    module.exports = require('dom-patch@1.0.4#apply/apply');
});
...
/*worker-render@1.2.0#window/event_handler*/
define('worker-render@1.2.0#window/event_handler', function (require, exports, module) {
...
/*worker-render@1.2.0#window/window*/
define('worker-render@1.2.0#window/window', function (require, exports, module) {
    var nodeRoute = require('node-route@1.0.3#dom-id');
    var applyPatches = require('dom-patch@1.0.4#apply');
    var makeEventHandler = require('worker-render@1.2.0#window/event_handler');
    var extend = require('worker-render@1.2.0#simple_extend');
...
/*worker-render@1.2.0#window*/
define('worker-render@1.2.0#window', function (require, exports, module) {
    module.exports = require('worker-render@1.2.0#window/window');
});
/*worker-render@1.2.0#window/global*/
define('worker-render@1.2.0#window/global', function (require, exports, module) {
    window.windowRender = require('worker-render@1.2.0#window');
});
/*[global-shim-end]*/
(function (){
