...
/*worker-render@1.1.8#window/event_handler*/
define('worker-render@1.1.8#window/event_handler', function (require, exports, module) {
...
/*worker-render@1.1.8#window/window*/
define('worker-render@1.1.8#window/window', function (require, exports, module) {
    var nodeRoute = require('node-route@1.0.3#dom-id');
    var applyPatches = require('dom-patch@1.0.4#apply');
    var makeEventHandler = require('worker-render@1.1.8#window/event_handler');
    var extend = require('worker-render@1.1.8#simple_extend');
...
define('worker-render@1.1.8#window', function (require, exports, module) {
    module.exports = require('worker-render@1.1.8#window/window');
});
/*worker-render@1.1.8#window/global*/
define('worker-render@1.1.8#window/global', function (require, exports, module) {
    window.windowRender = require('worker-render@1.1.8#window');
});
/*[global-shim-end]*/
(function (){
